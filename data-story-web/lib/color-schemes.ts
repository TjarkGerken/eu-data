...
export function interpolateColor(stops: ColorStop[], position: number): string {
  ...
  return position <= stops[0].position
    ? stops[0].color
...
export function createLeafletColorFunction(
  scheme: RasterColorScheme,
...
export const PREDEFINED_COLOR_SCHEMES: RasterColorScheme[] = [
  {
    ...
    description:
      "Standard risk assessment color scheme from white through yellow and orange to dark red",
  ...
  },
  {
    ...
    description:
      "Hazard assessment colors from white through orange to dark red",
  ...
  },
  {
    ...
    description:
      "Exposition layer colors from white through light green to dark green and black",
  ...
  },
  {
    ...
    description:
      "Relevance layer colors from white through various shades of green",
  ...
  },
  {
    ...
    description:
      "Economic risk assessment from white through green to red and black",
...
export function getSchemesByCategory(category: string): RasterColorScheme[] {
  return PREDEFINED_COLOR_SCHEMES.filter(
...
export function getDefaultSchemeForLayerType(
  layerType: string,
): RasterColorScheme {
...
export function getAllCategories(): string[] {
  const categories = new Set(
    PREDEFINED_COLOR_SCHEMES.map((scheme) => scheme.category),
  );

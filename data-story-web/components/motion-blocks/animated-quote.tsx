...
export function AnimatedQuote() {
  ...
  const quote = {
    text:
      language === "de"
        ? "Der Klimawandel ist nicht nur eine Umweltkrise – er ist eine Krise der menschlichen Rechte, der Gerechtigkeit und der politischen Entscheidungsfindung."
        : "Climate change is not just an environmental crisis – it is a crisis of human rights, of justice, and of political will.",
    author: "Greta Thunberg",
    role: language === "de" ? "Klimaaktivistin" : "Climate Activist",
  }
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-[#2d5a3d]/5 to-[#c4a747]/5 border-none shadow-lg">
          <CardContent className="p-12 text-center">
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              <div className="text-lg font-semibold text-[#2d5a3d]">{quote.author}</div>

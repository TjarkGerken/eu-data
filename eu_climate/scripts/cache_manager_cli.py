...
Examples:
  ...
  %(prog)s --info                     Show cache configuration
    ...
    parser.add_argument(
        "--info", action="store_true", help="Show cache configuration information"
    )
    parser.add_argument(
        "--enable", action="store_true", help="Enable caching (modifies config)"
    )
    parser.add_argument(
        "--disable", action="store_true", help="Disable caching (modifies config)"
    )
